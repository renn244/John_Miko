...
import { useGetAccommodationOptionsQuery } from "@/features/shared/accommodations/hooks/useAccommodationQueries";
...
const BookingFilter = () => {
  ...
  return (
    <div className="border-b bg-card px-4 py-3">
      <AdminFilterLayout search={<SearchBookingFilter />}>
        ...
        <div className="relative w-full sm:w-auto">
          <Select
            value={paymentType || ""}
            onValueChange={(value) => updatePaymentType(value)}
          >
            <SelectTrigger className="w-full sm:w-auto">
  ...
  return (
    <div className="relative w-full sm:w-auto">
      <Select
        ...
        onValueChange={(value) => updateAccommodationId(value)}
      >
        <SelectTrigger className="w-full sm:w-auto">
