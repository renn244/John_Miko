...
import StaffReportReviewCard from "@/features/admin/staff-reports/components/StaffReportReviewCard";
import {
    formatStaffReportType,
    getStaffReportSeverityClasses,
    getStaffReportStatusClasses,
    getStaffReportTypeClasses,
} from "@/features/admin/staff-reports/components/staffReportDisplay";
import { Badge } from "@/components/ui/badge";
import { Card } from "@/components/ui/card";
import LoadingSpinner from "@/components/ui/loadingSpinner";
import { useGetBookingById } from "@/features/admin/bookings/hooks/useAdminBookings";
import { useGetStaffReportByIdQuery } from "@/features/admin/staff-reports/hooks/useStaffReports";
            ...
            <div className="grid grid-cols-1 items-start gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
                <div className="space-y-6">
                    <Card className="gap-0 rounded-xl border bg-card p-5 shadow-sm">
                        ...
                        <h3 className="mb-2 break-words font-semibold">{report.title}</h3>
