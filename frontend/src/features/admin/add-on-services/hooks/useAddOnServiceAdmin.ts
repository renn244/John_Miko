import { addOnServiceApi } from "@/features/admin/add-on-services/api/adminAddOnService.api";
import type { GetAddOnServicesQuery, UpdateAddOnServiceAvailabilityDto } from "@/features/shared/add-on-services/types/add-on-service.type";
