...
const KnowledgeEditor = ({
    ...
    const editor = useEditor({
        extensions: [
            ...
            Placeholder.configure({
                placeholder:
                    "Write the public information the chatbot should know…",
            }),
        ],
        content: value,
        editable: !disabled,
    ...
    if (!editor || editor.isDestroyed) {
        return (
            <div className="min-h-[470px] animate-pulse rounded-lg bg-muted/40" />
        );
    }
