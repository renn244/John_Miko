                ...
                {isLoading ? (
                    ...
                    data.data.map((item) => (
                        <button
                            ...
                            className={`w-full rounded-lg border p-3 text-left transition-colors hover:bg-muted/60 ${selectedDocumentId === item.id ? "border-primary bg-primary/5" : "border-border"}`}
                        >
