...
const AccommodationSideBooking = ({
    ...
    const canBookOnline = user?.role === USER_ROLES.GUEST;
            ...
            <div className="mt-4 space-y-2">
                {canBookOnline ? (
                    ...
                    <p className="rounded-md border bg-muted/40 px-3 py-2 text-center text-xs text-muted-foreground">
                        Online bookings are available to guest accounts. Use the Admin Portal to record manual bookings or walk-ins.
                    </p>
                ) : (
