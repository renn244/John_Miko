...
import type { AccommodationReport } from "@/types/admin/accommodation.type";
import type { MaintenanceReport } from "@/types/admin/maintenance.type";
import type { PaymentReportBreakdown } from "@/types/admin/payment.type";
import type { DailyMetricsReport } from "@/types/admin/report.type";
import type { StaffReportSummary } from "@/types/admin/staff-report.type";
...
export const reportApi = {
    ...
    exportReport: async (date: string, format: "csv" | "xlsx") => {
        ...
        const fallbackName = `john-mikos-place-report-${date}.${format}`;
